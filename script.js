...
const account2 = {
  ...
  movementsDates: [
    ...
    '2022-06-28T14:18:46.235Z',
    '2022-07-05T16:33:06.386Z',
    '2022-07-10T14:43:26.374Z',
    '2022-07-15T18:49:59.371Z',
...
const displayMovements = function (acc, sort = false) {
  ...
  movs.forEach(function (mov, i) {
    ...
    const foramttedMov = formatCur(mov, acc.locale, acc.currency);
    ...
    <div class="movements__date">${displayDate}</div>
      ...
      i + 1
        ...
        <div class="movements__value">${foramttedMov}</div>
      </div>
    `;
